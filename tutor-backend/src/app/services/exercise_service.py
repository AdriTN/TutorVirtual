...
from ..models import Exercise, UserResponse, Theme, UserThemeProgress
from ..utils.utils import strip_and_lower

def create_exercise_from_ai(data: dict, tema: Theme, db: Session) -> Exercise:
    ej = Exercise(
...
def register_user_answer(user_id:int, ej:Exercise,
